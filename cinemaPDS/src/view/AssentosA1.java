...
public class AssentosA1 extends JFrame {
	...
	public AssentosA1() {
		...
		contentPane.setLayout(new MigLayout("",
				"[47px,grow][47px,grow][35px,grow][47px,grow][47px,grow][47px,grow][47px,grow][47px,grow][37px,grow][47px,grow][47px,grow][47px,grow][47px,grow][47px,grow]",
				"[49px,grow][49px,grow][][35px,grow][35px,grow][35px,grow][35px,grow][49px,grow]"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int refBanco = nBanco;
				// esse valor vai constar incrementado (manualmente) em cada instancia da classe
				// Jbutton

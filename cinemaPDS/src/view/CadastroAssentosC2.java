...
public class CadastroAssentosC2 extends JFrame {
	...
	private float valorIngresso = 22;
	...
	public CadastroAssentosC2(int row, int col) {
		...
		contentPane.setLayout(new MigLayout("", "[100.00px,grow 71][138.00px,grow][170px][138.00px,grow][16px,grow]", "[grow][53px][grow][41px][22.00px][45px][][16px][16.00px][][9.00][16.00][10.00px,grow][6][grow]"));
		...
		contentPane.add(lblNewLabel, "cell 1 3,alignx center,aligny center");
				...
				contentPane.add(txtNome, "cell 2 3,growx,aligny center");
		...
		contentPane.add(btnListar, "cell 1 11 3 1,grow");
		...
		contentPane.add(panel, "cell 1 12 3 1,grow");
		...
		contentPane.add(btnAlterar, "cell 1 14 3 1,alignx center,aligny center");
